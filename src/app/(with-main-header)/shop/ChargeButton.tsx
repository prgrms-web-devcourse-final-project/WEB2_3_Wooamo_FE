...
export default function ChargeButton() {
  ...
  return (
    <>
      <Button onClick={() => open("charge")} className="absolute -right-6">
        충전
      </Button>

      <Modal modalId="charge">
        <div className="flex flex-col items-center w-full gap-8">
          <span className="font-semibold text-xl">포인트 숍</span>
          <div className="flex flex-col w-full gap-4">
            {payments.map((payment) => (
              ...
              >
                <p className="font-semibold text-xl">{payment.point}p</p>
